---
title: "Supplementary materials for the imitation meta-analysis"
author: "JD"
date: "18 May 2017"
...
rm(list=ls())
setwd("C:\\Users\\Topsy\\Downloads")
library(metafor)
library(rmeta)
library(data.table)
library(plyr)

dat <- read.csv("imitation meta final.csv")
...
dat$vi.1 <- as.numeric(dat$var.d.) # Variance of the effect size
...
rml <- rma.mv(gi.1, vi.1, random = list(~ 1 | ID.L1, ~ 1 | ID.L2), data=tgt)
```
